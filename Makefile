...
bootstrap:
	curl https://github.com/twbs/bootstrap/releases/download/v4.5.0/bootstrap-4.5.0-dist.zip -o /tmp/bootstrap_files.zip
	unzip /tmp/bootstrap_files.zip -d bootstrap_files
...
theme_css:
	...
	curl https://bootswatch.com/4/superhero/_bootswatch.scss -o bikeGarage/static/scss/_variables.scss
